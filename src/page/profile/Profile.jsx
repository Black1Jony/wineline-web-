...
export default function Profile() {
  ...
  const certificates = Array.isArray(user?.certificates)
    ? user.certificates
    : [];
  const activeCodes = Array.isArray(user?.activeCodes)
    ? user.activeCodes
    : Array.isArray(user?.activeCode)
    ? user.activeCode
    : [];
        ...
        <MotionConfig reducedMotion="user">
          ...
          >
            <Card className="shadow-sm">
                ...
                <div className="flex-1 w-full text-center md:text-left">
                  ...
                  <div className="mt-4 mb-4">
                    ...
                    <div className="mt-1 text-xs text-gray-500">
                      {user.score > 0
                        ? "Доступно для оплаты покупок"
                        : "Накапливайте баллы при покупках"}
                    </div>
                  </div>
              ...
              <Descriptions
                title={
                  <span className="text-lg sm:text-xl">Данные профиля</span>
                }
                size="small"
                column={{ xs: 1, sm: 2 }}
                bordered
              >
                ...
                <Descriptions.Item label="Промокоды активно">
                  {certificates.length || activeCodes.length || 0}
                </Descriptions.Item>
              </Descriptions>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <Text className="block text-sm text-gray-600">
                      При покупке на сумму свыше 1000₽ вы получаете баллы (1
                      балл = 25₽)
                    </Text>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <Text className="block text-sm text-gray-600">
                      Используйте накопленные баллы для оплаты покупок в
                      магазине
                    </Text>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <Text className="block text-sm text-gray-600">
                      У вас {user.score || 0} баллов.{" "}
                      {user.score > 0
                        ? "Можете потратить их в магазине!"
                        : "Сделайте первую покупку, чтобы начать накапливать баллы."}
                    </Text>
                  </div>
                </div>
              </div>
